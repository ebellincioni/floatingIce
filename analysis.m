...
readraw;
directory = '/Users/edoardo/Library/CloudStorage/OneDrive-UniversityofTwente/floating/2023-12-08/1st/';
...
for ii=1:6:nfiles
    ...
    imshow(I2(100:4000,1500:6500)); % y,x
    % imshow(I2);
    ...
    csvwrite(directory+"contours_rev2/"+sprintf('%04d',ii)+".csv",contours)
    close
end 
%% show contours
figure()
