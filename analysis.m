...
readraw;
directory = '/Users/edoardo/Library/CloudStorage/OneDrive-UniversityofTwente/floating/2023-09-20/1st/';
...
for ii=1:3:nfiles
    ...
    csvwrite("/Users/edoardo/Library/CloudStorage/OneDrive-UniversityofTwente/floating/2023-09-20/1st/contours/"+sprintf('%04d',ii)+".csv",contours)
    close
end 
%% show contours
figure()
