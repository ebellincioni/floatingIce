...
!                        xxx = xc(k)
!                        yyy = ym(j)
!                        vx(k,j,i) = 0.0d0!vx(k,j,i) - eps*xxx**2*(1.0 - xxx)**2*cos(2.0*pi*yyy/ylen)

!                        xxx = xm(k)
!                        yyy = yc(j)
!                        vy(k,j,i) = 0.0d0!vy(k,j,i) + 2.0*eps*xxx*(1.0 - xxx)*(1.0 - 2.0*xxx)*sin(2.0*pi*yyy/ylen)/pi
!                    end do
!                end do
!            end do
!        end if
...
!                    do k=1,nxm
!                        xxx = xm(k)
!                        vy(k,j,i) = 0.0d0!min(ren,320.0)/12.0*xxx*(2*xxx-1)*(xxx-1)
!                    end do
!                end do
!            end do
!        else
...
!                    vx(k,j,i) = 0.0!1e-5*(varptb-0.5)
!                    call random_number(varptb)
!                    vy(k,j,i) = 0.0!1e-5*(varptb-0.5)
!                    call random_number(varptb)
!                    vz(k,j,i) = 0.0!1e-5*(varptb-0.5)
!                end do
!            end do
!        end do
!    end if
...
!                do k=1,nxm
!                    xxx = xm(k)
!                    temp(k,j,i) = 0.0d0! tempbp(1,j,i) + (temptp(1,j,i) - tempbp(1,j,i))*xm(k)/alx3
!                end do
!            end do
!        end do
